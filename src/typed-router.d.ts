...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/bigScreen/batch/detail/team/doc/': RouteRecordInfo<'/bigScreen/batch/detail/team/doc/', '/bigScreen/batch/detail/team/doc', Record<never, never>, Record<never, never>>,
    '/bigScreen/batch/detail/team/doc/doc-form': RouteRecordInfo<'/bigScreen/batch/detail/team/doc/doc-form', '/bigScreen/batch/detail/team/doc/doc-form', Record<never, never>, Record<never, never>>,
    '/bigScreen/batch/detail/team/team-card': RouteRecordInfo<'/bigScreen/batch/detail/team/team-card', '/bigScreen/batch/detail/team/team-card', Record<never, never>, Record<never, never>>,
    '/bigScreen/batch/detail/team/team-form': RouteRecordInfo<'/bigScreen/batch/detail/team/team-form', '/bigScreen/batch/detail/team/team-form', Record<never, never>, Record<never, never>>,
    ...
    'SetPage': RouteRecordInfo<'SetPage', '/bigScreen/setting copy', Record<never, never>, Record<never, never>>,
    '/bigScreen/setting copy/onlyTest/': RouteRecordInfo<'/bigScreen/setting copy/onlyTest/', '/bigScreen/setting copy/onlyTest', Record<never, never>, Record<never, never>>,
    '/bigScreen/setting copy/print/': RouteRecordInfo<'/bigScreen/setting copy/print/', '/bigScreen/setting copy/print', Record<never, never>, Record<never, never>>,
    '/bigScreen/setting copy/startSet/process': RouteRecordInfo<'/bigScreen/setting copy/startSet/process', '/bigScreen/setting copy/startSet/process', Record<never, never>, Record<never, never>>,
    '/bigScreen/setting copy/startSet/reader': RouteRecordInfo<'/bigScreen/setting copy/startSet/reader', '/bigScreen/setting copy/startSet/reader', Record<never, never>, Record<never, never>>,
    '/bigScreen/setting copy/startSet/turnline': RouteRecordInfo<'/bigScreen/setting copy/startSet/turnline', '/bigScreen/setting copy/startSet/turnline', Record<never, never>, Record<never, never>>,
