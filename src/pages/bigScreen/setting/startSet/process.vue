<template>
  <div class="wh-full">
    ...
    <div class="p-x-1em p-y-2em">
      <div class="flex">
        <div class="flex flex-1">
          <a-button type="link" class="btn hover:text-[#89f7ff]!">
            流程测试
          </a-button>
          <div class="m-l-2em h-90% w-80% border-3 border-[#7ff3fd]">
        ...
        <div class="flex flex-col flex-1 items-center">
          <main class="mb-2em">
            <a-select v-model:value="value1" size="large" style="width: 320px">
            ...
            <a-button type="link" class="btn m-l-1em hover:text-[#89f7ff]!">
              摄像头拍照
            </a-button>
          </main>
          <div>
